...
public class SimpleTextinLabel {
	...
	private void initialize(){
		...
		jf = new JFrame("U3-1 P1"); 						//Instantiate frame and sets title.
		...
		jif1 = new JInternalFrame("LabelToggle");			//Instantiate and sets title.
		...
		// LABEL setup
		lbDisplayResults = new JLabel("Howdy!");			//Sets up label.
	...
	private class PBResultAction implements ActionListener {
		public void actionPerformed(ActionEvent event){
				if(lbDisplayResults.getText().equals("Howdy!")){
					lbDisplayResults.setText("Good bye!");
				} else {
	...
	public static void main(String[] args){
		new SimpleTextinLabel();	//Simple GUI start.
